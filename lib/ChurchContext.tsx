...
function checkIsQuotaExceededStored(): boolean {
  ...
  try {
    ...
    // Auto-expire quota exceeded status after 3 hours to automatically retry on new day/quota reset
        ...
        getDoc(mainDocRef)
          .then((snap) => {
            if (snap.exists()) {
              ...
              setSyncState(isFirestoreQuotaExceeded ? 'quota_exceeded' : 'ready');
            }
          })
          .catch((e) => {
